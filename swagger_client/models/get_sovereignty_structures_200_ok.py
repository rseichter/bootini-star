...
class GetSovereigntyStructures200Ok(object):
    ...
    def __init__(self, alliance_id=None, solar_system_id=None, structure_id=None, structure_type_id=None, vulnerability_occupancy_level=None, vulnerable_start_time=None, vulnerable_end_time=None):  # noqa: E501
