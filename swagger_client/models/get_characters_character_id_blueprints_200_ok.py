...
class GetCharactersCharacterIdBlueprints200Ok(object):
    ...
    def __init__(self, item_id=None, type_id=None, location_id=None, location_flag=None, quantity=None, time_efficiency=None, material_efficiency=None, runs=None):  # noqa: E501
    ...
    def location_id(self):
        ...
        References a solar system, station or item_id if this blueprint is located within a container. If the return value is an item_id, then the Character AssetList API must be queried to find the container using the given item_id to determine the correct location of the Blueprint.  # noqa: E501
