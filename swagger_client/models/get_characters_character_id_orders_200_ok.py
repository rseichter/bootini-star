...
class GetCharactersCharacterIdOrders200Ok(object):
    ...
    def __init__(self, order_id=None, type_id=None, region_id=None, location_id=None, range=None, price=None, volume_total=None, volume_remain=None, issued=None, is_buy_order=None, min_volume=None, escrow=None, duration=None, is_corporation=None):  # noqa: E501
