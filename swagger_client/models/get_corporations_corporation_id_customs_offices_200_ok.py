...
class GetCorporationsCorporationIdCustomsOffices200Ok(object):
    ...
    def __init__(self, office_id=None, system_id=None, reinforce_exit_start=None, reinforce_exit_end=None, corporation_tax_rate=None, allow_alliance_access=None, alliance_tax_rate=None, allow_access_with_standings=None, standing_level=None, excellent_standing_tax_rate=None, good_standing_tax_rate=None, neutral_standing_tax_rate=None, bad_standing_tax_rate=None, terrible_standing_tax_rate=None):  # noqa: E501
