...
class GetCharactersCharacterIdStandings200Ok(object):
    ...
    def standing(self, standing):
        ...
        if standing is not None and standing > 10:  # noqa: E501
            raise ValueError("Invalid value for `standing`, must be a value less than or equal to `10`")  # noqa: E501
        if standing is not None and standing < -10:  # noqa: E501
            raise ValueError("Invalid value for `standing`, must be a value greater than or equal to `-10`")  # noqa: E501
