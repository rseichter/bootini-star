...
class FittingsApi(object):
    ...
    def delete_characters_character_id_fittings_fitting_id_with_http_info(self, character_id, fitting_id, **kwargs):  # noqa: E501
        ...
        all_params = ['character_id', 'fitting_id', 'datasource', 'token', 'user_agent', 'x_user_agent']  # noqa: E501
    ...
    def get_characters_character_id_fittings_with_http_info(self, character_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/characters/{character_id}/fittings/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def post_characters_character_id_fittings(self, character_id, fitting, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.post_characters_character_id_fittings(character_id, fitting, async=True)
        >>> result = thread.get()
    ...
    def post_characters_character_id_fittings_with_http_info(self, character_id, fitting, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.post_characters_character_id_fittings_with_http_info(character_id, fitting, async=True)
        >>> result = thread.get()
        ...
        all_params = ['character_id', 'fitting', 'datasource', 'token', 'user_agent', 'x_user_agent']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            '/v1/characters/{character_id}/fittings/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
